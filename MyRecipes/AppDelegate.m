...
{
    // The directory the application uses to store the Core Data store file. This code uses a directory named "dasha.ruto.Weather" in the application's documents directory.
